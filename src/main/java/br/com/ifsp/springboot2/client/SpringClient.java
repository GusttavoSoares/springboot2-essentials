...
//        log.info("saved anime {}", kingdomSaved);
        ...
        ResponseEntity<Void> samuraiChamplooUpdated = new RestTemplate().exchange("http://localhost:444/animes/",
                HttpMethod.PUT,
        ...
        ResponseEntity<Void> samuraiChamplooDelete = new RestTemplate().exchange("http://localhost:444/animes/{id}",
                HttpMethod.DELETE,
                null,
                Void.class,
