...
class AnimeControllerIT {
    ...
    @Autowired
    private IfspUserRepository ifspUserRepository;
    private static final IfspUser USER = IfspUser.builder()
            .name("Ifsp school")
    ...
    private static final IfspUser ADMIN = IfspUser.builder()
            .name("Gustavo Soares")
            .password("{bcrypt}$2a$10$hSTIR1LEGbkA6US1B0IJVeoTsHrFKzPwXSeE40SvIFckopmMHoUTm")
            .username("soares")
    ...
    static class Config {
        ...
        public TestRestTemplate testRestTemplateRoleUserCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    ...
                    .basicAuthentication("ifsp", "academy");
        ...
        public TestRestTemplate testRestTemplateRoleAdminCreator(@Value("${local.server.port}") int port) {
            RestTemplateBuilder restTemplateBuilder = new RestTemplateBuilder()
                    .rootUri("http://localhost:"+port)
                    .basicAuthentication("soares", "academy");
            return new TestRestTemplate(restTemplateBuilder);
        }
    }
